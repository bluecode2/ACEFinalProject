		...
		<ol class="breadcrumb">
			<logic:iterate name="breadCrumb" id="menu">
				<logic:equal name="menu" property="menuId" value="${currMenuId}">
					<li class="active"><bean:write name="menu" property="menuCaption" /></li>
				</logic:equal>
				<logic:notEqual name="menu" property="menuId" value="${currMenuId}">
					<logic:notEqual name="menu" property="menuUrl" value="#">	
						<li><a class="breadcrumbNode" href="<bean:write name="menu" property="menuUrl" />"><bean:write	name="menu" property="menuCaption" /></a></li>
					</logic:notEqual>
